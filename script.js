...
let songs = [
    ...
    },
    {
        ...
        lyrics: [
            ...
            { time: 23, text: "Terucap kata cinta" },
            { time: 27, text: "Yang dulu tersimpan" },
            { time: 30, text: "Dan tak mau pergi" },
            { time: 44, text: "Sekejap cinta yang terjalin" },
            { time: 47, text: "Dan menjadi sebuah cerita" },
            { time: 51, text: "Yang tak mungkin terlupa" },
            { time: 55, text: "Terukir di hati" },
            { time: 59, text: "Dan tak mau pergi" },
            { time: 65, text: "Mungkinkah kumiliki" },
            { time: 67.5, text: "Cinta seperti ini lagi" },
            { time: 72, text: "Jangan biarkan aku" },
            { time: 74, text: "Kehilangan dirimu" },
            { time: 81, text: "Coba dengarkanlah sumpahku" },
            { time: 84, text: "(Janji suci) dari hati" },
            { time: 90, text: "Aku cinta kamu" },
            { time: 95, text: "Jangan dengar kata mereka" },
            { time: 98, text: "Yang tak ingin kita satu" },
            { time: 103.5, text: "Yakinkan aku milikmu" },
            { time: 108.5, text: "Aku milikmu" },
            { time: 120.5, text: "Jalinan cinta tulus suci" },
            { time: 123.8, text: "Terpadu terikat erat" },
            { time: 127.5, text: "Jangan terpisah lagi" },
            { time: 131, text: "Waktu 'kan menguji" },
            { time: 135, text: "Cinta kita berdua" },
            { time: 140.5, text: "Mungkinkah kumiliki" },
            { time: 144, text: "Cinta seperti ini lagi" },
            { time: 148.5, text: "Jangan biarkan aku" },
            { time: 151, text: "Kehilangan dirimu" },
            { time: 157.5, text: "Coba dengarkanlah sumpahku" },
            { time: 161, text: "(Janji suci) dari hati" },
            { time: 165.5, text: "Aku cinta kamu" },
            { time: 171, text: "Jangan dengar kata mereka" },
            { time: 175, text: "Yang tak ingin kita satu" },
            { time: 180.2, text: "Yakinkan aku milikmu" },
            { time: 184.5, text: "Aku milikmu" },
            { time: 210, text: "Mungkinkah kumiliki" },
            { time: 213, text: "Cinta seperti ini lagi" },
            { time: 218, text: "Jangan biarkan aku" },
            { time: 220, text: "Kehilangan dirimu" },
            { time: 227, text: "Coba dengarkanlah sumpahku" },
            { time: 230, text: "(Janji suci) dari hati" },
            { time: 235.5, text: "Aku cinta kamu" },
            { time: 240, text: "Jangan dengar kata mereka" },
            { time: 244.5, text: "Yang tak ingin kita satu" },
            { time: 250, text: "Yakinkan aku milikmu" },
            { time: 254, text: "Aku milikmu" },
            { time: 259, text: "Coba dengarkanlah sumpahku" },
            { time: 261.5, text: "(Janji suci) dari hati (dari lubuk hati)" },
            { time: 268, text: "Aku cinta kamu (aku cinta kamu)" },
            { time: 273, text: "Jangan dengar kata mereka" },
            { time: 275.5, text: "Yang tak ingin kita satu" },
            { time: 282, text: "Yakinkan aku milikmu" },
            { time: 286, text: "Aku milikmu" },
